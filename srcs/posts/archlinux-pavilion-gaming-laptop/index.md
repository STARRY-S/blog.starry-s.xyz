...
# Others
 ...
 - 因为前几天改配置文件时又踩了一遍锁死的坑，于是拿着相机内存卡（我U盘放学校寝室里拿不出来了）做了最新的(2020.07.01)live CD救砖时，惊喜的发现在live环境下`lspci`和关机都不会卡死了，~~貌似是新版内核驱动修复了nouveau的问题~~ 应该是我在几个月前升级了电脑的Bios，解决的这个问题，因为我又新下了一个旧的live CD，关机和lspci也都正常了（算了不管到底是怎么回事了，能用就行
